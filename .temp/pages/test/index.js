...
export default @connect(({ test, common, loading }) => ({
  ...test,
  ...common,
  loading
}))
class Test extends Component {
  ...
  circleInit = () => {
    var cxt_arc = Taro.createCanvasContext('canvasCircle', this);
  ...
  drawCircle = () => {
    var ctx = Taro.createCanvasContext('canvasArcCir', this);
  ...
  render() {
    return <View className="test-page">
              ...
              return <View key={index} className={`day ${dayObject.className}`}>{dayObject.day}</View>;
                ...
                <View className="wrap">
                    <View className="circle-box">
                        <Canvas className="circle" style="z-index: -99; width:200px; height:200px;" canvasId="canvasCircle" ref={ref => {
            this['__taroref_canvasCircle'] = ref;
          }}>
                        </Canvas>
                        <Canvas className="circle" style="width:200px; height:200px;" canvasId="canvasArcCir" ref={ref => {
            this['__taroref_canvasArcCir'] = ref;
          }}>
                        </Canvas>
